...
let initialProducts = [
  { id: 1, name: 'Fan', category: 'Electronic', price: 2000.0, stockQuantity: 20 },
  { id: 2, name: 'new Hp laptop', category: 'Electronic', price: 30000, stockQuantity: 15 },
  { id: 3, name: 'one plus advance', category: 'mobile', price: 80000, stockQuantity: 10 },
  { id: 4, name: 'Lenovo 2024 model', category: 'laptop', price: 99999, stockQuantity: 20 },
  { id: 5, name: 'samsung LED Tv', category: 'Electronic', price: 20000, stockQuantity: 15 },
  { id: 6, name: 'Fridge', category: 'Electronic', price: 30000, stockQuantity: 10 },
  { id: 7, name: 'Dress', category: 'Clothes', price: 1000, stockQuantity: 20 },
  { id: 8, name: 'Table', category: 'Furniture', price: 15.99, stockQuantity: 15 },
  { id: 9, name: 'plant', category: 'Home & garden', price: 20.99, stockQuantity: 10 },
  { id: 10, name: 'product', category: 'Category ', price: 10.99, stockQuantity: 20 },
